...
<!-- 预申报单列表页面 -->
  <div>
    ...
    <JFX-search-panel @reset="resetForm" @search="getList(1)" :showOpenBtn="false">
      <el-form :model="ruleForm" ref="ruleForm">
        <el-row :gutter="10">
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="6">
            <el-form-item  label="生效月份：" prop="effectiveDate" class="search-panel-item fs-14 clr-II" >
              <el-date-picker
                clearable
    ...
    <el-row class="mr-t-20">
      <el-col :span="24" >
        <el-button type="primary" :size="'small'" @click="$successMsg('成功导出')">审核</el-button>
      </el-col>
    </el-row>
    <!-- 操作 end -->
    ...
    >
      ...
      <el-table-column prop="historyPrice" label="调整前单价" align="center" width="120"></el-table-column>
      <el-table-column prop="price" label="调整后单价" align="center" width="120"></el-table-column>
      <el-table-column prop="adjustPriceResult" label="调价原因" align="center" show-overflow-tooltip></el-table-column>
      <el-table-column prop="modifier" label="提交人" align="center" width="120"></el-table-column>
    </JFX-table>
    <!-- 表格 end-->
  </div>
</template>
