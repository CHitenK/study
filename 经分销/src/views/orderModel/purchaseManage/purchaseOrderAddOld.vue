      ...
      <el-row  :gutter="10" class="fs-14 clr-II">
        ...
        <el-col class="mr-b-0" :xs="24" :sm="12" :md="12" :lg="8" :xl="6" >
          <el-form-item label="包装方式：" prop="packType" >
            ...
            <!-- <el-select v-model="ruleForm.packType" style="width: 100%" placeholder="请选择" filterable clearable :data-list="getSelectList('adjustmentType_sourceList')" >
...
import { checkDepotMerchantRel, getDepotInfo, getPurchasePriceManage, saveOrUpdateTempOrder, checkContractNoAndPoNo, savePurchaseOrder, getPurchaseOrderDetails } from '@a/purchaseManage/index'
