<template>
  ...
  <div class="page-bx bgc-w">
    ...
    <JFX-table :tableData.sync="tableData" @selection-change="selectionChange" @change="getList">
      ...
      <el-table-column prop="settlementMonth" align="center" min-width="80" label="结转月份" />
      <el-table-column prop="depotName" align="center" min-width="200" label="仓库名称" />
      ...
      <el-table-column prop="surplusNum" align="center" min-width="80" label="库存余量" />
      <el-table-column prop="availableNum" align="center" min-width="100" label="仓库现余量" />
      ...
      <el-table-column prop="stateLabel" align="center" min-width="80" label="结转状态" />
      <el-table-column prop="createDate" align="center" min-width="150" label="快照时间" />
