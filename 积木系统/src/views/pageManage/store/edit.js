// import { transformTime } from './../utils/tool.js'
// import Cookies from 'js-cookie'
/**
 * @description 编辑专题的store
 */
const state = {
  ...
  titleData: {// 专题数据
    // specialId: transformTime(), // 专题 （见原型生成规则）
    // pfChannelId: +localStorage.getItem('CHANNEL_ID'), // 渠道id
    // createName: Cookies.get('sec_username'), // 创建人
