<template>
    <div>
        ...
        <div class="container fadeIn">
          ...
          <Compliance v-if="activeColumnId !== 827 && activeColumnId !== 1140 && !showList" :activeId="activeColumnId" :recordsData="records" :boxImg="img" :detailImg="detailImg" :title="title" v-on:toShowList="toShowList"/>
        </div>
...
export default {
    components: { Policy, Compliance, SecondaryList },
    data() {
        return {
            menu: [], // 导航栏
            pageSize: 10, // 一页几条数据
